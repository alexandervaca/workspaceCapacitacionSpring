 ...
 */
package com.eduit.spring.clase2.conf;
...
@ComponentScan({"com.eduit.spring.clase2.dao","com.eduit.spring.clase2.service"})
@PropertySource("classpath:application.properties")
@EnableJpaRepositories("com.eduit.spring.clase2.dao")
