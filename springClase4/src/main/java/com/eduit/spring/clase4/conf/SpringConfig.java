...
@ComponentScan({"com.eduit.spring.clase4.dao", "com.eduit.spring.clase4.service","com.eduit.spring.clase4.controller","com.eduit.spring.clase4.rest"})
@PropertySource("classpath:application.properties")
@EnableJpaRepositories("com.eduit.spring.clase4.dao")
@Import({ SecurityConfig.class })//todo lo de securityconfig pasa a esta clase.
